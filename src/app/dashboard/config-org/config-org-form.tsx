...
export function ConfigOrgForm({ orgConfig }: { orgConfig: OrgConfigView }) {
  ...
  return (
    <form className="grid gap-6" onSubmit={onSubmit}>
      <div className="flex items-center gap-4 rounded-2xl bg-surface-sunken p-4">
        <Logo
      ...
      <fieldset className="grid gap-3">
        ...
        {parceiros.map((p, i) => (
          <div key={i} className="grid gap-3 rounded-2xl bg-surface-sunken p-4 sm:grid-cols-2">
